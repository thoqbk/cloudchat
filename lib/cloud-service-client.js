...
module.exports = function (container) {
    ...
    fetchServiceDefinitions()
            .then(function (serviceDefinitions) {
                ...
                buildAndRegisterServiceProxies(container, requiredServiceDefinitions);
                retVal.resolve();
            })
            .fail(function (error) {
                retVal.reject(error);
...
function buildAndRegisterServiceProxies(container, serviceDefinitions) {
    var retVal = [];
    for (var serviceName in serviceDefinitions) {
        ...
        container.register(serviceName, serviceInstanceProxy);
        //debug
        $logger.info("Register remote service proxy successful. Service name: " + serviceName);
    }
    return retVal;
}
